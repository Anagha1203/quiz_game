...
public class Delete1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 730, 190, 100));
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from geo1 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from geo2 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from geo3 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
