 ...
 * @author rasika
 */
public class Gk2 extends javax.swing.JFrame{
...
Connection con=ConnectionProvider.getCon();
Statement st=con.createStatement();
ResultSet rsl=st.executeQuery("select *from gk2  where id='"+questionId+"'");
while(rsl.next())
{
...
JOptionPane.showMessageDialog(null, e);
    ...
    /**
     * Creates new form Gk2
     */
public Gk2() {
        initComponents();
}
    public Gk2(String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 730, 160, 90));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, 1350, 70));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 32)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(240, 240, 240));
        jLabel3.setText("00");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 650, 80, 50));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1320, 800, -1, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 32)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 0, 51));
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 280, 40, 40));
...
jRadioButton1.setSelected(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gk2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
