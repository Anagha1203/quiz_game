 ...
 * @author rasika
 */
public class Name6 extends javax.swing.JFrame {

    /**
     * Creates new form Name6
     */
    public Name6() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Name6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
