 ...
 * @author rasika
 */
public class Geo3 extends javax.swing.JFrame {
...
Connection con=ConnectionProvider.getCon();
Statement st=con.createStatement();
ResultSet rsl=st.executeQuery("select *from geo3  where id='"+questionId+"'");
while(rsl.next())
{
...
JOptionPane.showMessageDialog(null, e);
    ...
    /**
     * Creates new form Geo3
     */
public Geo3() {
        initComponents();
}
    public Geo3(String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 660, 80));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 510, 670, 80));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 360, 650, 80));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 510, 630, 80));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 32)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(240, 240, 240));
        jLabel3.setLabelFor(jLabel3);
        jLabel3.setText("00");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 656, 70, 50));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 32)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(240, 240, 240));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 166, 1350, 80));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1350, 790, -1, -1));
...
jRadioButton4.setSelected(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Geo3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
