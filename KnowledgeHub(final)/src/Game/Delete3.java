...
public class Delete3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 730, 170, 100));
        ...
        getContentPane().add(jButton7, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 729, 190, 100));
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from tech1 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from tech2 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from tech3 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
