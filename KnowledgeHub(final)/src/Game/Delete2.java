...
public class Delete2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 730, 180, 100));
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from sports1 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from sports2 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
...
{
   Connection con=ConnectionProvider.getCon();
   PreparedStatement ps=con.prepareStatement("delete from sports3 where id=?");
   ps.setString(1, id);
   ps.executeUpdate();
