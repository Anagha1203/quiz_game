 ...
 * @author rasika
 */
public class Geo1 extends javax.swing.JFrame {
...
Connection con=ConnectionProvider.getCon();
Statement st=con.createStatement();
ResultSet rsl=st.executeQuery("select *from geo1  where id='"+questionId+"'");
while(rsl.next())
{
...
JOptionPane.showMessageDialog(null, e);
    ...
    /**
     * Creates new form Geo1
     */
public Geo1() {
        initComponents();
}

    public Geo1(String name) {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 750, 170, 80));
        ...
        jLabel3.setText("00");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(751, 656, 70, 50));
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 796, 140, 20));
...
jRadioButton1.setSelected(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Geo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
