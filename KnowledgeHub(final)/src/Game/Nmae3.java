 ...
 * @author rasika
 */
public class Nmae3 extends javax.swing.JFrame {

    /**
     * Creates new form Nmae3
     */
    public Nmae3() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 710, 180, 90));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nmae3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
